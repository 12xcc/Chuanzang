      ...
      <div class="Symptoms">
        <div class="Condition">
          ...
          <el-radio-group
            ...
            @change="handleComplicationsChange"
          >
          ...
          <div class="Condition">
            ...
            <div class="flex gap-2">
              ...
              <div class="NextContainer">
                <el-form-item v-if="form.OtherComplications" label="其他并发症" style="padding: 15px 0 15px 0" labei-position="left">
                  <el-input
...
export default {
  ...
  methods: {
    ...
    handleComplicationsChange(value) {
      if (!value) {
        // 清空所有并发症
        for (const key in this.form) {
          if (key.startsWith("Has") && key !== "HasComplications") {
            this.form[key] = false;
          }
        }
      }
