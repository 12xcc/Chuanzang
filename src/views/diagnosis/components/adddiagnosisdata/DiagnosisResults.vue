...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        otherDiseaseName: [{ required: true, message: "请填写其他疾病" }],
  ...
  methods: {
    toggleDisease(disease) {
      ...
      if (this.form.diseaseType !== "其他") {
        this.form.otherDiseaseName = ""; // 清空其疾病输入框
      }
    },
